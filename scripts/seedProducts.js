...
dotenv_1.default.config({ path: './.env' }); // Adjust path if your .env is elsewhere
...
async function seedProducts() {
    try {
        for (const product of products) {
            await pool.query(`INSERT INTO products (name, category, description, price, image_url, suggested_amount)
         VALUES ($1, $2, $3, $4, $5, $6)`, [
                product.name,
                product.category,
                product.description,
